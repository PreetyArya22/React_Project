  ...
  return (
    <div className="row mx-0 LearningSection">
      <div className="col-12 px-0">
        ...
        <div className="row mx-0 justify-content-center py-lg-5 pb-4">
                  ...
                  <div className="card div-2 text-center rounded-0">
                    <div className="card-body d-flex flex-column justify-content-center align-items-center gap-3">
                      ...
                      <div className="d-flex flex-column justify-content-center align-items-center gap-1">
                        <div className="icon-div d-flex border-0 rounded-circle justify-content-center align-items-center">
                          <span className="m-0">{data.icon}</span>
                        </div>
